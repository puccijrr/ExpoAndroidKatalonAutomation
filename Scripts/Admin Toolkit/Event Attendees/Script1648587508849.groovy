...
//Click to Enter Event Attendees and ensure correct page from header
Mobile.tap(findTestObject('Object Repository/Admin Toolkit/android.widget.TextView - Event Attendees'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/Admin Toolkit/Event Attendees/android.widget.TextView - EVENT ATTENDEES'),
	3, FailureHandling.STOP_ON_FAILURE) //Event Attendees page header


//Select Back to Admin Toolkit
Mobile.tap(findTestObject('Object Repository/Admin Toolkit/Event Attendees/android.widget.ImageButton - Back'), 0)
