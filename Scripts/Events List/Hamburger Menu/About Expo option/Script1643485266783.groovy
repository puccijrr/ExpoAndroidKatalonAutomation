...
Mobile.tap(findTestObject('Object Repository/Events List/Hamburger Menu/android.widget.TextView - About Expo'), 1)
Mobile.delay(3)

//Check navigation to expopass.com by checking expected elements on mobile browser
