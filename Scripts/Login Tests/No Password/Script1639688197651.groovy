...
//Enter valid username email but NO password, Tap main Login button
...
Mobile.verifyElementExist(findTestObject('Object Repository/Login Objects/ErrorPop_Invalid Password'), 0, FailureHandling.STOP_ON_FAILURE)
Mobile.verifyElementExist(findTestObject('Login Objects/ErrorPop_Password field cannot be empty'), 0, FailureHandling.STOP_ON_FAILURE)
