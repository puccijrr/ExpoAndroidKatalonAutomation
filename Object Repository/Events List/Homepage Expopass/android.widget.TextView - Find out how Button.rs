...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Find out how Button</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Find out how' or . = 'Find out how')]</locator>
