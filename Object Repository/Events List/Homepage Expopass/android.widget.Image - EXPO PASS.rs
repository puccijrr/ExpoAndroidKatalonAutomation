...
<MobileElementEntity>
   ...
   <name>android.widget.Image - EXPO PASS</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Image' and (@text = 'EXPO PASS' or . = 'EXPO PASS')]</locator>
